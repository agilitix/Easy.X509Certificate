...
namespace Easy.X509.Tests
{
    ...
    class X509FinderTests
    {
        ...
        {
            // This certificate (by thumbprint or serial number) is used for dev on IIS.
        ...
        public void Thumbprint_or_SerialNumber_should_select_certificates_in_all_stores(X509Selector selector)
        {
